...
public class TestClass {
    ...
    public String statement( Vector<Rental> _rentals, String customerName) {
        ...
        while (rentals.hasMoreElements()) {
            ...
            switch (each.getMovie().getPriceCode()) {
                case Movie.REGULAR: thisAmount+= 2; if (each.getDaysRented() > 2) thisAmount+= (each.getDaysRented() -2) * 1.5; break;
